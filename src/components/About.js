    ...
    <section id="about">
      <div className="bg-slate-900 w-full">
        <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center h-screen">
          <div className="lg:flex-grow lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left text-justify mb-16 md:mb-0 items-center">
